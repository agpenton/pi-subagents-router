 ...
 */
import { analyzeTaskDescription, Supervisor } from "../src/Supvisor.js";
import { BUILTIN_AGENTS } from "../src/BuiltinAgents.js";
// ==========================================================================
...
const ROUTE_TEST_CASES = [
    ...
    },
    {
        ...
        expectedAgent: "software-engineer",
        description: "NEW FIX: 'implement' at pos 0 beats 'documentation' at pos 10",
    },
    {
    ...
    },
    {
        ...
        description: "useWhen/avoidWhen: software-engineer scored but penalized, fallback to reviewer",
    },
    {
        input: "",
...
async function main() {
    ...
    const r0 = runRouteTests("Group 0: analyzeTaskDescription — backward compat", ROUTE_TEST_CASES);
    // Group 1: Supervisor class
    const r1 = runSyncTests("Group 1: Supervisor class creation", CLASS_TESTS);
    // Group 2: planAndRoute smoke test
    const r2 = await runAsyncTests("Group 2: planAndRoute smoke test", [
        {
